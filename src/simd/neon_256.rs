...
impl super::Vector for NEON256Vector {
    ...
    #[inline(always)]
    unsafe fn zero() -> Self {
        Self((vdupq_n_u8(0), vdupq_n_u8(0)))
    }

    #[inline(always)]
    unsafe fn splat_u8(value: u8) -> Self {
        Self((vdupq_n_u8(value), vdupq_n_u8(value)))
    }
    ...
    unsafe fn eq_u8(self, other: Self) -> Self {
        Self((vceqq_u8(self.0.0, other.0.0), vceqq_u8(self.0.1, other.0.1)))
    }

    #[inline(always)]
    unsafe fn gt_u8(self, other: Self) -> Self {
        Self((vcgtq_u8(self.0.0, other.0.0), vcgtq_u8(self.0.1, other.0.1)))
    }

    #[inline(always)]
    unsafe fn lt_u8(self, other: Self) -> Self {
        Self((vcltq_u8(self.0.0, other.0.0), vcltq_u8(self.0.1, other.0.1)))
    }
    ...
    unsafe fn smax_u16(self) -> u16 {
        vmaxvq_u16(vreinterpretq_u16_u8(self.0.0)).max(vmaxvq_u16(vreinterpretq_u16_u8(self.0.1)))
    }
    ...
    unsafe fn and(self, other: Self) -> Self {
        Self((vandq_u8(self.0.0, other.0.0), vandq_u8(self.0.1, other.0.1)))
    }

    #[inline(always)]
    unsafe fn or(self, other: Self) -> Self {
        Self((vorrq_u8(self.0.0, other.0.0), vorrq_u8(self.0.1, other.0.1)))
    }

    #[inline(always)]
    unsafe fn not(self) -> Self {
        Self((vmvnq_u8(self.0.0), vmvnq_u8(self.0.1)))
    }
