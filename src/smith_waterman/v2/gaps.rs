...
use crate::smith_waterman::v2::ops::{
    _mm256_shift_right_epi16, _mm256_shift_right_four_epi16, _mm256_shift_right_two_epi16,
};
...
pub unsafe fn propagate_horizontal_gaps(
    ...
    // row: [0, 4, 0, 0, 0, ...]
    let shifted = _mm256_shift_right_epi16(row);
    ...
    let shifted = _mm256_shift_right_two_epi16(row);
    let gap_penalty = _mm256_blendv_epi8(
    ...
    let shifted = _mm256_shift_right_four_epi16(row);
    let gap_penalty = _mm256_blendv_epi8(
